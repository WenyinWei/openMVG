...
int main()
{
  ...
  **/
  ...
  // TODO: Check image really works here
  ublas::matrix<ublas::matrix<ScalarType>> image;
  ...
  **/
  ...
  // TODO: Vienna image okay?
  viennacl::matrix<viennacl::vector<ScalarType>> vcl_image;
